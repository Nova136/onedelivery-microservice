        ...
        const sops: Partial<Sop>[] = [
            ...
            },
            {
                ...
                workflowSteps: [
                    ...
                    "9. ITEM CHECK: If the issueCategory is 'missing_item' or 'wrong_item', check the 'quantityRefunded' for the specificItems. If 'quantityRefunded' is equal to or greater than 'quantityOrdered', return a rejection string: 'This specific item has already been fully refunded.'",
                    "10. Calculate the new refund value. Each line has 'price' = unit price and 'itemValue' = total for that line. For missing/wrong items: refund dollars = (units being refunded) × (unit 'price'); never use 'price' alone as the total when refunding more than one unit. For a full line refund, the amount may equal that line's 'itemValue'. (Late: $5, Quality: 20% of relevant item value, Missing/wrong: quantity × unit price.)",
